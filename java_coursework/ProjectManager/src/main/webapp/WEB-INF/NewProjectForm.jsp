...
<body class="container mt-5">
	...
	<form:form  class="form" action="/project/save/new" method="post" modelAttribute="newProject">
		...
		<input class="btn btn-outline-primary mt-2" type="submit" value="Create New Project"/> <%-- could also set this in controller by using setters and session--%>
	</form:form>
