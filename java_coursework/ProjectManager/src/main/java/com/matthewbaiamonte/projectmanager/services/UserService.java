...
import com.matthewbaiamonte.projectmanager.models.LoginUser;
import com.matthewbaiamonte.projectmanager.models.User;
import com.matthewbaiamonte.projectmanager.repositories.UserRepository;
...
public class UserService {
    ...
    public User register(User newUser, BindingResult result) {     // This method will be called from the controller whenever a user submits a registration form.
