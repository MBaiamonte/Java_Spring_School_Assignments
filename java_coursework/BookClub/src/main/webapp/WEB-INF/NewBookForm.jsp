...
<body class="container mt-5">
	<div class="row d-flex justify-content-between" id="header">
		<h1 class="col-5">Add A Book To Your Shelf</h1>
		<a href="/user/dashboard" class="btn btn-outline-primary col-3">Return to the shelves</a>
	</div>
	<form:form class="form" action="/book/save/new" method="post" modelAttribute="book">
		...
		<input class="btn btn-outline-primary mt-2" type="submit" value="Create new book"/>
	</form:form>
